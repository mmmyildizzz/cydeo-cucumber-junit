...
public class Order_StepDefinitions {
   ...
   public void userEntersQuantity(int arg0) {
       ...
       // since sendKeys() method only accepts String, we need to either concat with "", or
       //send String.valueOf(int);

       //clear() will delete whatever is in the input box
       orderPage.inputQuantity.clear();
        orderPage.inputQuantity.sendKeys(arg0+""); //or
    ...
    public void user_enters_city(String string) {
        orderPage.inputCity.sendKeys(toString());
    ...
    public void user_should_see_in_first_row_of_the_web_table(String expectedName) {
       // System.out.println("viewAllOrdersPage.newCustomerCell.getText() = "
            //    + viewAllOrdersPage.newCustomerCell.getText()); // Sherlock Holmes
